...
2. [0002 — The supervisor spawns by `kind`, from a closed registry (runtimes wire themselves)](0002-runtime-agnostic.md) — **Proposed**
...
6. [0006 — Auth: `claude auth login` + credentials on RW PVC, bootstrap via Job](0006-auth.md) — **Superseded by 0007**
7. [0007 — Runtime auth = static long-lived `setup-token` (not rotating creds)](0007-static-oauth-token.md) — **Accepted**, incident-driven 2026-07-02
